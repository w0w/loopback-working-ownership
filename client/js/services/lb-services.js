  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use UserThing.user() instead.
        "::get::UserThing::user": {
          url: urlBase + "/UserThings/:id/user",
          method: "GET"
        },
...
/**
 * @ngdoc object
 * @name lbServices.UserThing
 * @header lbServices.UserThing
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `UserThing` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#create
         * @methodOf lbServices.UserThing
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `UserThing` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/UserThings",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.UserThing#upsert
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#exists
         * @methodOf lbServices.UserThing
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/UserThings/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.UserThing#findById
         * @methodOf lbServices.UserThing
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/UserThings/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.UserThing#find
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#findOne
         * @methodOf lbServices.UserThing
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/UserThings/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.UserThing#updateAll
         * @methodOf lbServices.UserThing
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/UserThings/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.UserThing#deleteById
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#count
         * @methodOf lbServices.UserThing
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/UserThings/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.UserThing#prototype$updateAttributes
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#updateOrCreate
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#update
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#destroyById
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.UserThing#removeById
         * @methodOf lbServices.UserThing
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.UserThing#modelName
    * @propertyOf lbServices.UserThing
    * @description
    * The name of the model represented by this $resource,
    * i.e. `UserThing`.
    */
    R.modelName = "UserThing";


        /**
         * @ngdoc method
         * @name lbServices.UserThing#user
         * @methodOf lbServices.UserThing
         *
         * @description
         *
        ...
        R.user = function() {
          ...
          var action = TargetResource["::get::UserThing::user"];
